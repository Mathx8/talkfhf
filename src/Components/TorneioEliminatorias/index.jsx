...
const TorneioEliminatorias = ({ partidas, competicao }) => {
  ...
  const renderPartida = (partida) => {
    const logoTimeCasa = times.find(t => t.nome === partida.time_casa)?.logo || "";
    const logoTimeFora = times.find(t => t.nome === partida.time_fora)?.logo || "";
            ...
            <PartidaContainer key={final.id}>
              ...
              <FinalContainer>
                <FinalTimeContainer vencedor={final.gols_casa > final.gols_fora}>
                  <Logo src={times.find(t => t.nome === final.time_casa)?.logo || ""} alt={final.time_casa} />
                ...
                <FinalTimeContainer vencedor={final.gols_fora > final.gols_casa}>
                  ...
                  <Logo src={times.find(t => t.nome === final.time_fora)?.logo || ""} alt={final.time_fora} />
                </FinalTimeContainer>
              </FinalContainer>
            </PartidaContainer>
          ) : (
